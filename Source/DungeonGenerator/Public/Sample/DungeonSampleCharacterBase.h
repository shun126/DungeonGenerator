...
public:
	/*
	 * Creates the sample character with the supplied object initializer.
	...
	/*
	 * Returns the transform recorded as the character home transform.
	 * キャラクターのホーム姿勢として記録された姿勢を返します。
	 */
	const FTransform& GetHomeTransform() const;

	/*
	 * Returns the location recorded as the character home position.
