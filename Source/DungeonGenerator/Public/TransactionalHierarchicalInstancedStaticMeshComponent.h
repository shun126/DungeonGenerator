...
#include "TransactionalHierarchicalInstancedStaticMeshComponent.generated.h"
...
class DUNGEONGENERATOR_API UTransactionalHierarchicalInstancedStaticMeshComponent : public UHierarchicalInstancedStaticMeshComponent
{
	GENERATED_BODY()
...
inline bool UTransactionalHierarchicalInstancedStaticMeshComponent::InTransaction() const
{
	return IsImmediate() == false;
}

inline bool UTransactionalHierarchicalInstancedStaticMeshComponent::IsImmediate() const
{
	return mImmediate;
}
