...
public:
	 ...
	 * 配置する方向
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "DungeonGenerator", meta = (ToolTip = "Direction rule applied when placing this actor part. Random Direction uses the synchronized generation random stream."))
