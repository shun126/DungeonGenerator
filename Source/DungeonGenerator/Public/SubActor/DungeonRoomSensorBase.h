...
protected:
	...
	*/
	UPROPERTY(BlueprintReadWrite, Category = "DungeonGenerator")
	...
	*/
	...
	ドアを追加する確率(0%～100%)
	*/
	UPROPERTY(BlueprintReadOnly, Category = "DungeonGenerator", meta = (ClampMin = "0", ClampMax = "100"))
	...
	*/
	 ...
	 * If the array is empty, the room will not spawn
	 * 
	 ...
	 * If the array is empty, it will not spawn
	 * 
