...
protected:
	...
	*/
	UPROPERTY(BlueprintReadWrite, Category = "DungeonGenerator", meta = (AllowPrivateAccess = "true"))
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "DungeonGenerator", meta = (ClampMin = "0", AllowPrivateAccess = "true"))
	...
	*/
	...
	ドアを追加する確率(0%～100%)
	*/
	UPROPERTY(BlueprintReadOnly, Category = "DungeonGenerator", meta = (ClampMin = "0", ClampMax = "100", AllowPrivateAccess = "true"))
	...
	*/
	UPROPERTY(BlueprintReadOnly, Category = "DungeonGenerator", meta = (AllowPrivateAccess = "true"))
	TArray<TObjectPtr<AActor>> DungeonTorchs;
...
inline bool ADungeonRoomSensorBase::OnPrepare_Implementation(const float depthFromStartRatio)
{
	return true;
}

inline UBoxComponent* ADungeonRoomSensorBase::GetBounding()
{
	return Bounding;
}

inline const UBoxComponent* ADungeonRoomSensorBase::GetBounding() const
{
	return Bounding;
}

inline const FBox& ADungeonRoomSensorBase::GetRoomSize() const noexcept
{
	return RoomSize;
}

inline uint8 ADungeonRoomSensorBase::GetDoorAddingProbability() const noexcept
{
	return DoorAddingProbability;
}

inline void ADungeonRoomSensorBase::SetDoorAddingProbability(const uint8 doorAddingProbability) noexcept
{
	DoorAddingProbability = doorAddingProbability;
}

inline bool ADungeonRoomSensorBase::OnNativePrepare(const FVector& center)
{
	return true;
}

inline void ADungeonRoomSensorBase::OnNativeInitialize()
{
}

inline void ADungeonRoomSensorBase::OnNativeFinalize(const bool finish)
{
}

inline void ADungeonRoomSensorBase::OnNativeReset(const bool fallToAbyss)
{
}

inline void ADungeonRoomSensorBase::OnNativeResume()
{
}
