...
public:
	 ...
	 * プラグインのバージョンを取得します
	 */
	UFUNCTION(BlueprintCallable, Category = "DungeonGenerator", meta = (ToolTip = "Get the version of the plugin"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "DungeonGenerator", meta = (ToolTip = "Get the URL of the plugin document"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "DungeonGenerator", meta = (ToolTip = "Get the URL of the plugin support page"))
	 ...
	 * ビルドタグを取得します
	 */
	UFUNCTION(BlueprintCallable, Category = "DungeonGenerator", meta = (ToolTip = "Get build tag"))
	 ...
	 * コミットIDを取得します
	 */
	UFUNCTION(BlueprintCallable, Category = "DungeonGenerator", meta = (ToolTip = "Get commit ID"))
	 ...
	 * プラグインの識別子を取得します
	 */
	UFUNCTION(BlueprintCallable, Category = "DungeonGenerator", meta = (ToolTip = "Get the plugin identifier"))
	 ...
	 * ライセンスを取得します
	 */
	UFUNCTION(BlueprintCallable, Category = "DungeonGenerator", meta = (ToolTip = "Get License Type"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "DungeonGenerator", meta = (ToolTip = "Transform from world location to texture location"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "DungeonGenerator", meta = (ToolTip = "Find DungeonRoomSensorBase by location", WorldContext = "worldContextObject"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "DungeonGenerator", meta = (ToolTip = "Find DungeonRoomSensorBase from the player", WorldContext = "worldContextObject"))
