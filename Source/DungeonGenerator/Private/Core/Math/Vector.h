...
namespace dungeon
{
	...
	*/
	inline FVector ToVector(const FIntVector& vector)
	{
	...
	*/
	inline FIntVector ToIntVector(const FVector& vector)
	{
	...
	*/
	inline FIntPoint ToIntPoint(const FIntVector& vector)
	{
	...
	(Note that the Z value is discarded.)
	*/
	inline FIntPoint ToIntPoint(const FVector& vector)
	{
