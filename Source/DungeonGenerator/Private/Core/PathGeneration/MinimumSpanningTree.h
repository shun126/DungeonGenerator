...
namespace dungeon
{
	...
	private:
		...
		*/
		...
		/**
		 * 開始地点にふさわしい点を検索します
		 * @param[in]	startLocationPolicy	開始地点ポリシー
		 * @return		開始地点にふさわしい点
		 */
		std::shared_ptr<const Point> FindStartPoint(const StartLocationPolicy startLocationPolicy) const noexcept;

		/**
		 * 開始地点にふさわしい点の集合を検索します
		 * @return		開始地点にふさわしい点の集合
		 */
